...
=======
  ...
  const hasPendingPayment = (classItem) => {
    ...
    // Don't show pending if enrollment was cancelled/rejected
  ...
  // Check if enrollment was rejected by admin
  const isEnrollmentRejected = (classItem) => {
    const enrollment = userEnrollments.find(
      (enrollment) => enrollment.class?._id === classItem._id
    );
...
=======
                          ...
                          ) : isEnrolled && isEnrollmentRejected(classItem) ? (
                            <VintageButton
                              variant="secondary"
                              size="md"
                              disabled
                            ...
                            >
                              <XCircle className="h-5 w-5 mr-2" />❌ Thanh toán
                              bị từ chối
>>>>>>> Stashed changes
                            </VintageButton>
                          ) : canEnroll ? (
...
=======
                            ...
                            <VintageButton
                              ...
                              className="w-full bg-gradient-to-r from-vintage-gold to-vintage-accent hover:from-vintage-accent hover:to-vintage-gold text-vintage-dark border-0 shadow-lg hover:shadow-xl font-bold py-3 transform hover:scale-105 transition-all duration-300"
                            >
                  ...
                  {user && (
                    <>
                      ...
                      hasConfirmedPayment(selectedClass) ? (
                        ...
                        isEnrollmentRejected(selectedClass) ? (
                        <VintageButton
                          variant="secondary"
                          disabled
