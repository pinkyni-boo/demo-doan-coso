...
export default function TrainerDashboard() {
  ...
  const ScheduleCard = ({ scheduleItem }) => (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 hover:shadow-md transition-shadow">
      <div className="flex items-center justify-between">
        <div className="flex-1">
          <h4 className="font-semibold text-gray-900">{scheduleItem.className}</h4>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">
              Chào mừng trở lại, {user?.fullName}! Quản lý lớp học và học viên của bạn.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-xl font-semibold text-gray-900">Lớp học được gán</h2>
                  <button 
                ...
                {dashboardData.assignedClasses.length > 0 ? (
                  <div className="grid gap-6">
                    {dashboardData.assignedClasses.slice(0, 3).map((classItem) => (
                  ...
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Chưa có lớp học được gán</h3>
                    <p className="text-gray-600">Liên hệ admin để được gán lớp học</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-xl font-semibold text-gray-900">Lịch hôm nay</h2>
                  <button 
                ...
                {dashboardData.todaySchedule.length > 0 ? (
                  <div className="space-y-4">
                    {dashboardData.todaySchedule.map((scheduleItem) => (
                      <ScheduleCard key={scheduleItem.id} scheduleItem={scheduleItem} />
                    ))}
                  </div>
                ) : (
                  <div className="text-center py-8">
                    <Calendar className="h-10 w-10 text-gray-400 mx-auto mb-3" />
                    <h3 className="font-medium text-gray-900 mb-1">Không có lớp học hôm nay</h3>
                    <p className="text-sm text-gray-600">Hãy nghỉ ngơi và chuẩn bị cho ngày mai!</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-900">Quản lý lớp học</span>
                </button>
                <button 
                  onClick={() => navigate('/trainer/schedule')}
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-900">Xem lịch dạy</span>
                </button>
                <button 
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-900">Dịch vụ</span>
                </button>
                <button 
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-900">Câu lạc bộ</span>
                </button>
              </div>
            </div>
          </div>
