                  ...
                  >
                    ...
                    {rooms.map((room) => (
                      <option key={room._id} value={room._id}>
                        {room.roomName} ({room.roomCode}) - {room.location}
                        {room.status !== "active" &&
                          ` [${
